...
| `index.html` | Frontend shell. Controls toolbar (outlook switch + view filters, a dropdown on phones), forecast strip, detail/map region, footer with the shared `/images/icon-rw.svg` back-to-apps mark. Loads Leaflet from unpkg. |
